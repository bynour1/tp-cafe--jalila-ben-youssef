...
public interface PromotionRepo extends JpaRepository<Promotion, Long> {
        ...
        List<Promotion> findByPourcentage(String p);
        ...
        long existsByPourcentage(String p);
        ...
        List<Promotion> findByPercentAndDebutRange(String p, LocalDate d1, LocalDate d2);
